...
\q{Ich fühle ein gutes, tapferes Herz schlagen}, sagte {\Salbana}, \q{Was soll der Seemannsgarn? Die alten Geschichten bleiben doch Geschichten, und wir sind jetzt und hier.}
\q{Ich glaube nicht an Gespenster oder Zauberer}, begann {\Eno}. \q{Und dabei habe ich auf meinen Reisen eine Menge ungeheuerlicher und abenteuerlicher Dinge gehört. Ich habe eine gute Seele gespürt. Und da ich geschworen habe, jedem zu helfen, der aus dem Grauen Turm entflieht, habe ich es mit mir genommen.}

\q{Vor Geistern und Aberglauben aus irgendwelchen fernen Ländern habe ich keine Angst}, antwortete {\Nox}, \q{Aber ich fürchte die {\Bangiri} und {\Pato}. Auch wenn sie in der Stadt {\Tern} gerade genug zu tun haben, so kann es doch sein, dass sie nach unserem kleinen Gast suchen, wenn sie können. Und eben darum bitte ich euch, es einige Tage bei euch aufzunehmen. Solange, bis wir wissen, wie sich die Dinge in der Stadt entwickeln.}\\
...
\q{{\Oka}, {\Nia}, {\Dua}, {\Ria}, {\Tea}, {\Pia}, {\Exa}, {\Sepa}}, zählte er leise. Es waren alles enländische Zahlwörter. \q{{\Sepa}}, wiederholte das Kind langsam.\\
\q{{\Sepa}. {\Nox} nickte. \q{Du hast dir für deinen Besuch einen schlechten Zeitpunkt ausgesucht. Das {\Enland} ist heute und hier ein trauriger Ort. Aber vielleicht wird ja nun alles besser.\\
...
\q{Siebenhoffnung!}, rief {\Piedo}}, als er in die Stube stürzte. Die ganze Zeit hatte er am Fenster gelauscht, aber nun hielt er es nicht mehr aus. \q{Das ist aber ein schöner Name!}

\chapter{Die Sucher kommen}
In den folgenden drei Tagen verzog sich langsam der Rauch über der Stadt {\Tern}. In dem Dorf {\Berna} blieben die Leute unruhig. Nachts zogen die alten Schattenläufer um den See, am zweiten Tag ging in aller Frühe {\Nox} mit zwei Begleitern in die Stadt. Sie kehrten abends mit der Dämmerung zurück, konnten aber nur berichten, dass die Wächter der Garde mit den Kriegern der {\Bangiri} in den Hallen am alten Seehafen ein Lager eingerichtet hatten. Außerdem wurden alle Tore streng bewacht. Von der Grauen Herrin gab es immer noch keine Spur. 

Der Frühling zog ins {\Enland} ein.\\
{\Salbana} verbrachte fast den gesamten Tag im Haus des alten {\Marn}. {\Sepa} ging es von Tag zu Tag besser. Nur dem dem Sprechen hatte sie ihre liebe Not. 
