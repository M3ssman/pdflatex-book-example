...
\q{Wenn du denkst, du kannst den ganzen Spaß für dich allein haben, hast du dich getäuscht. Du warst so lange fort. Stundenlang! Wir haben uns Sorgen gemacht.}\\
\q{Komm}, {\Eno} winkte seinem Gefährten. \q{Du hast Recht! Verlassen wir diese Ruinen!}\\
\q{Wir sollten den Leute helfen}, meinte {\Bomar}.\\
\q{Es ist hier viel zu gefährlich für uns! Die Straßen wimmeln von {\Bangiri}s und Kriegern der {\EnlanderGarde}! Und ich denke nicht, dass sie für uns heute eine Ausnahme machen!}
...
{\Bomar} hatte die Gestalt eines Luchses. Rechts und links prangte ein mächtiger, weißer Backenbart, der bis auf die Schultern fiel. Auch {\Eno} setzte die Kapuze ab. Sein Fell schimmerte weiß in der Dunkelheit. Eine dunkle Augenklappe bedeckte sein linkes Auge.
...
\q{Was ist das?} zischte {\Bomar} unruhig. \q{So etwas habe ich noch nie gesehen!}\\
...
{\Bomar} schüttelte sein mächtiges Haupt. \q{Das bedeutet gewiss Ärger. {\Nox} wird darüber nicht erfreut sein.}
...
{\Bomar} nahm {\Eno} das Kind ab. Dieser war vom langen Tragen erschöpft. Wie man jetzt sehen konnte, war er auch ein alter Fuchs, und hatte, wie seine Gefährten, schon viele Sommer und Winter im {\Enland} und in {\Rhingell} kommen und gehen sehen. Er war froh, dass er sich mit den anderen beiden die Last teilen konnte. Gemeinsam folgten sie dem Pfad, der sich zwischen den Hügeln oberhalb des Sees entlang schlängelte.

\section{Das geheime Lager im Dorf}
Als die Sonne schon hoch am Himmel stand, kamen sie in nach {\Berna}.\\
Das Dorf bot, wie viele Siedlungen im {\Enland}, einen eher traurigen Anblick. Es erstreckte sich eine halbe Wegstunde oberhalb des Sees an einem Hang. Fast die Hälfte der Häuser von {\Berna} war mit den Jahren verlassen, aber die große Gemeindehalle am oberen Ende des Dorfes wurde eifrig gepflegt.
...
\q{Ich kann es dir nicht sagen}, antwortete {\Eno}, \q{und ich weiß auch nicht, ob es tatsächlich so ist, oder ob ich mich täusche. Aber in dem Moment, als der Turm zerfallen ist, habe ich auf einmal gewusst, dass mit dem Turm die Macht der {\GraueHerrin} eingestürzt ist.}\\
\q{Wirklich?}\\
...
\Nox hat hier das Sagen und befiehlt, dass das Kind hier nicht bleiben kann und dass das geheime Lager verschlossen werden soll. Er rechnet mit einer großen Suche und umherziehenden \Bangiri im \Enland{.}
