...
\q{{\Eno}, sagte {\Nox}}, und seine Stimme klang zitterte, \q{ich habe gesehen, wie der Turm zu Staub zerfallen ist. Ich kann mir nicht vorstellen, mit welchem Zaubertrick jemand an diesem Ort das überlebt haben kann. Also, sage mir die Wahrheit: Wo hast du dieses Wesen gefunden? Wo war es versteckt?}
...
{\Eno} nickte ihr zu.\\
\q{Wir müssen zunächst dafür sorgen, dass es gesund wird. Aber ich halte es für eine schlechte Idee, wenn es hier bleibt. Wir können es nicht im Dorf lassen. Die Gefahr für uns alle wäre zu groß. Ich werde es hinunter zum See bringen, nach {\AltBerna}. Dort leben nur die alte {\Tea} und der alte {\Marin} mit seinem Ziehsohn, {\Molitor}. Sie werden uns gewiss helfen. Du, {\Salbana}}, fuhr er fort und blickte die Graufüchsin in dem blauen Gewand an, \q{hast dort Ruhe, um dich um deinen kleinen Patienten zu kümmern.}
